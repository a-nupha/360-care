                ...
                <v-container>
                    ...
                    ">
                            ...
                            <v-container fluid>
                                <v-col cols="12" md="12">
                                    <v-flex>
                                        <v-text-field :label="lablefirstName" :placeholder="placeholderfirstName" outlined dense :rules="rules" :counter="50" :maxlength="50" v-model="firstName"></v-text-field>
                                        <v-text-field :label="lablelastName" :placeholder="placeholderlastName" outlined dense :counter="50" :maxlength="50" v-model="lastName"></v-text-field>
                                        <v-flex v-if="flaglanguage == 'th'">
                                            <v-text-field :label="lablePid" :placeholder="placeholderPid" v-mask="'#-####-#####-##-#'" outlined dense :maxlength="17" v-model="pid"></v-text-field>
                                            <v-flex md4>
                                                <div>
                                        ...
                                        <v-flex v-if="flaglanguage == 'eg'">
                                            <v-text-field :label="lablePid" :placeholder="placeholderPid" outlined dense :maxlength="20" v-model="pid"></v-text-field>
                                            <v-flex md4>
                                                <div>
                                                    <v-menu ref="menu" v-model="menu" :close-on-content-click="false" transition="scale-transition" offset-y min-width="auto">
                                                        <template v-slot:activator="{ on, attrs }">
                                                            <v-text-field v-model="date" label="birthday" prepend-icon="mdi-calendar" readonly outlined dense v-bind="attrs" v-on="on"></v-text-field>
                                                        </template>
                                        ...
                                        <v-flex md12>
                                        <v-text-field :label="lableTel" :placeholder="placeholderTel" outlined dense :maxlength="20" v-model="mobile"></v-text-field>
                                        </v-flex>
                                        <v-flex md12>
                                        ...
                                        <v-flex md12 style="color: #0277bd;" class="d-flex align-left justify-left pa-1 mx-auto">
                                            ที่อยู่ : {{district}} {{amphoe}} {{province}} 
                                        </v-flex>
                                        <v-flex md12>
