...
function SearchArray($dataItems,$barcode,$conn)
{
    ...
    { 
        ...
        if(gettype($key)=='boolean'){
            ...
            $queryitem = "INSERT INTO `items`(`barcode`, `name`, `desc`, `cate_id`, `price`, `cost`, `remark`) VALUES ('".$barcode[$i]['barcodeItems']."', '".$barcode[$i]['name']."', '".$barcode[$i]['detailItems']."', '".$barcode[$i]['cate_id']."', ".$barcode[$i]['price_Piece'].", ".$barcode[$i]['cost_Piece'].", '".$barcode[$i]['remark']."')";
            ...
            values ('".$barcode[$i]['barcodeItems']."', '".$barcode[$i]['branch_id']."', '".$barcode[$i]['Qty_Piece']."', null, '".$barcode[$i]['remark']."')";
            ...
            InsertReport($conn,$barcode[$i]['barcodeItems'],$barcode[$i]['date_in'],$barcode[$i]['Qty_Piece'],$barcode[$i]['branch_id']);
            ...
            values (NULL,'".$barcode[$i]['barcodeItems']."', '".$barcode[$i]['date_in']."','".$barcode[$i]['add_time']."', '".$barcode[$i]['branch_id']."', '".$barcode[$i]['Qty_Piece']."', '".$barcode[$i]['status_id']."', '".$barcode[$i]['approve_id']."', '".$barcode[$i]['pid_user']."', '".$barcode[$i]['pid_approve']."', '".$barcode[$i]['remark']."', ".$barcode[$i]['price_Piece'].", ".$barcode[$i]['cost_Piece'].")";
            ...
            // echo "\r\n\r\n\r\n\r\n else \r\n\r\n\r\n\r\n";
            $barcode_stock = $barcode[$i]['barcodeItems'];
            ...
            if($resultItems)
                ...
                $new_quantity_in = $quantity_old + $barcode[$i]['Qty_Piece'];
